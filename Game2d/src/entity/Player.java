...
public class Player extends Entity{
	...
	public void getPlayerImage() {
		try {
			...
			still = ImageIO.read(getClass().getResourceAsStream("/player/cat_still.png"));
	...
	public void update() {
		...
		if(keyH.upPressed == true || keyH.downPressed == true || 
			...
			if(keyH.upPressed == true) {
				direction = "up";
				y -= speed; // this is the same as writing 'playerY = playerY - playerSpeed;'
			}
			...
			spriteCounter++; // updates every 15 frames, and there are 60 frames per second
			if (spriteCounter > 10) {
				if(spriteNum == 1) {
					spriteNum = 2;
				}
